...
$$P(Y \in K_j | X_i) = P(X_1|Y).P(X_2|Y)......P(X_i|Y) . \ P(Y \in K_j),where \  X_i \ \text{are the number of inputs and Y is discrete response variable and } K_j \ \text{are the number of class labels}$$.
