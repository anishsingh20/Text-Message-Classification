...
Now let's train the K-nearest neighbor model.
...
mean(knn.pred==spam.test[,1])*100

#the predicted class argument of the roc() function expects a ordered factor
auc<-roc(as.factor(spam.test[,1]),ordered(knn.pred))

plot(auc)
auc$auc
auc$sensitivities #true positive rate-TPR- is a spam message
auc$specificities #true negetive rate-TNR-not a spam message


```


Hence we can observe that the K-NN classifier gave us an AUC value of 0.82
